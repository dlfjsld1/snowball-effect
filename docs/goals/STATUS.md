...
| S2-G1 공·점수 데이터 | Content/Systems | PENDING | 2026-08-12 제품 계약 변경으로 재검증 필요. 2026-08-11 Resource 검증의 Lv14 `Black Hole`/`black_hole`, score `1e50`, radius/mass/fx tier는 최신 계약과 일치한다. 그러나 최신 catalog의 Lv6 Sun/Lv7 Red Giant/Lv9 Nebula/Lv10 Galaxy와 현재 Resource의 Lv6 Gas Giant/Lv7 Sun/Lv9 Galaxy/Lv10 Galaxy Cluster가 불일치한다. 이동 Black Hole 맵 기믹은 동명 concept이지만 BallDefinition과 별도다. Content/Systems가 Owned Files의 나머지 catalog drift를 맞추고 CLI/MCP/runtime을 다시 검증하기 전 `VERIFIED`로 올리지 않는다. |
...
- S2-G1은 2026-08-12 catalog 변경으로 `PENDING`에 되돌렸다. 기존 Lv14 Black Hole Resource는 유지하지만 Lv6/Lv7/Lv9/Lv10 drift를 수정하고 다시 검증해야 한다.
