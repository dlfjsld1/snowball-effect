...
- Reduced Effects: 점멸·jitter 없이 정적인 황색 outline과 상태 문구 사용
- Cleanup: Time Up 감광은 Settlement/Clear/Failure handoff, Retry, Main, 새 Run 전에 해제
...
![Time CRT Pulse v1](time-crt-pulse-v1.png)
