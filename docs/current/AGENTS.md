...
- Split a physics tick at the exact deadline. Only movement, collisions, merges, and bottom crossings inside the remaining pre-deadline gameplay interval may commit as gameplay events.
