...
func _ready() -> void:
	...
	_verify_finale_lock_and_resets(game_manager, stage_manager, simulation)
...
func _verify_finale_lock_and_resets(game_manager: GameManager, stage_manager: StageManager, simulation: BallSimulationManager) -> void:
